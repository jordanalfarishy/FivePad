...
| FR-1.14 | P1 | Semua | **Dua cara memandang isi yang sama**: sebagai Markdown yang tertata, atau sebagai teks biasa apa adanya. Pilihannya berlaku untuk kelima slot sekaligus — ia menyangkut cara membaca, bukan isi catatannya — dan tidak mengubah satu karakter pun yang tersimpan. |
| FR-1.15 | P1 | Semua | Menu penyuntingan teks, mengikuti FiveNotes: To do, Header, Bold, Italic, Bold Italic, Mark, Strike, Quote, List, Ordered List, Code, Code Block, Shift Right, Shift Left. Di Android diakses lewat ikon `titlecase` di bilah atas dan tampil sebagai lembar bawah; di macOS lewat menu utama dengan pintasan papan tik. Setiap tindakan bersifat **membalik** — menerapkannya pada teks yang sudah memakainya justru mencabutnya, karena penanda Markdown selalu ada di dua tempat terpisah yang mudah luput satu saat dihapus manual. |
